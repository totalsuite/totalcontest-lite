...
<script type="text/ng-template" id="dashboard-translate-component-template">
    <div class="totalcontest-box totalcontest-box-translate">
        <div class="totalcontest-box-section">
            <div class="totalcontest-box-title"><?php _e( 'Translate', 'totalcontest' ); ?></div>
            <div class="totalcontest-box-description"><?php _e( 'Help us translate TotalContest to your language and get an item from our store for free.', 'totalcontest' ); ?></div>
			<?php
			$url = add_query_arg(
				[
					'utm_source'   => 'in-app',
			...
			?>
            <a href="<?php echo esc_attr( $url ); ?>" target="_blank" class="button button-primary button-large"><?php _e( 'Translate', 'totalcontest' ); ?></a>
        </div>
    </div>
</script>
<script type="text/ng-template" id="dashboard-subscribe-component-template">
    <div class="totalcontest-box totalcontest-box-subscribe">
        <div class="totalcontest-box-section">
            <div class="totalcontest-box-title"><?php _e( 'Stay in the loop', 'totalcontest' ); ?></div>
            <div class="totalcontest-box-description"><?php _e( 'Get latest news about new features, products and deals plus a <strong>10% discount</strong> to use in our store!', 'totalcontest' ); ?></div>
            <form class="totalcontest-box-composed-form" action="<?php echo esc_attr( $this->env['links']['subscribe'] ); ?>" target="_blank">
                ...
                <button type="submit"
                        class="button button-primary button-large totalcontest-box-composed-form-button"><?php _e( 'Subscribe', 'totalcontest' ); ?></button>
            </form>
        </div>
        <div class="totalcontest-box-section totalcontest-box-subscribe-social">
            <div class="totalcontest-box-title"><?php _e( 'Follow us', 'totalcontest' ); ?></div>
...
<script type="text/ng-template" id="dashboard-review-component-template">
    <div class="totalcontest-box totalcontest-box-review">
        <div class="totalcontest-box-section">
            <div class="totalcontest-box-title"><?php _e( 'Spread the word', 'totalcontest' ); ?></div>
            <div class="totalcontest-box-description"><?php _e( 'Please consider <a href="https://codecanyon.net/downloads/">leaving a review</a>. You could also get a chance to win a free item from our store by tweeting about TotalContest!', 'totalcontest' ); ?></div>
