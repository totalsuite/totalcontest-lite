        ...
        <div class="totalcontest-tab-content active">
            ...
            <div class="totalcontest-settings-item">
                <div class="totalcontest-settings-field">
                    <label class="totalcontest-settings-field-label" for="field-votes"><?php _e( 'Votes', 'totalcontest' ); ?></label>
                ...
                <div class="totalcontest-settings-item" ng-repeat="rating in information.ratings">
                    <div class="totalcontest-settings-field">
                        ...
                        <table class="wp-list-table widefat striped">
                            <tr>
                                <td><?php _e( 'Votes', 'totalcontest' ); ?></td>
                                <td><?php _e( 'Cumulative', 'totalcontest' ); ?></td>
                                <td><?php _e( 'Rate', 'totalcontest' ); ?></td>
                            </tr>
                            <tr>
                                <td>
