<div class="totalcontest-integration">
    <div class="totalcontest-integration-tabs">
		...
		<?php foreach ( $integrationTabs as $integrationTabId => $integrationTab ): ?>
            <div class="totalcontest-integration-tabs-item <?php echo $integrationTabId == $firstIntegrationTab ? 'active' : ''; ?>" tab-switch="editor>integration>methods><?php echo esc_attr( $integrationTabId ); ?>">
