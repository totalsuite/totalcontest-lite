<customizer-tabs>
    <customizer-tab target="primary"><?php _e( 'Primary', 'totalcontest' ); ?></customizer-tab>
    <customizer-tab target="secondary"><?php _e( 'Secondary', 'totalcontest' ); ?></customizer-tab>
    <customizer-tab target="accent"><?php _e( 'Accent', 'totalcontest' ); ?></customizer-tab>
    <customizer-tab target="gray"><?php _e( 'Gray', 'totalcontest' ); ?></customizer-tab>
    <customizer-tab target="dark"><?php _e( 'Dark', 'totalcontest' ); ?></customizer-tab>
</customizer-tabs>
