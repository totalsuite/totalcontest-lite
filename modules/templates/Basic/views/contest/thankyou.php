...
?>
    <div class="totalcontest-page-content totalcontest-page-content-thank-you">
		...
		<?php if ( $contest->getMenuItemVisibility( 'submissions' ) ): ?>
            <a class="totalcontest-button" href="<?php echo esc_attr( $menuItems['submissions']['url'] ); ?>"><?php _e( 'Browse submissions', 'totalcontest' ); ?></a>
		<?php endif; ?>
    </div>
<?php
