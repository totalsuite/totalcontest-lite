...
return apply_filters(
	...
	array(
		...
		'path'           => plugin_dir_path( TOTALCONTEST_ROOT ),
		...
		'db'             => array(
			...
			'tables'     => array(
				'log'   => $GLOBALS['wpdb']->prefix . 'totalcontest_log',
				'votes' => $GLOBALS['wpdb']->prefix . 'totalcontest_votes',
			),
			'prefix'     => (string) $GLOBALS['wpdb']->prefix,
			'charset'    => (string) $GLOBALS['wpdb']->get_charset_collate(),
		),
		'api'            => array(
			'update'             => 'https://totalsuite.net/api/v1/products/totalcontest/update/',
			'store'              => 'https://totalsuite.net/api/v1/products/totalcontest/store/{{license}}/',
			'activation'         => 'https://totalsuite.net/api/v1/products/totalcontest/activate/',
		...
		'links'          => array(
			...
			'changelog'      => 'https://totalsuite.net/product/totalcontest/changelog/#version-2.0.2',
